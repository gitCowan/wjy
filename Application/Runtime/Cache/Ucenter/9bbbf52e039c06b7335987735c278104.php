				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h2><i class="fa fa-table red"></i><span class="break"></span><strong>返佣记录</strong></h2>
						...
						<div class="panel-body">
							<table class="table table-striped table-bordered bootstrap-datatable datatable">
							  ...
							  <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
	                                    ...
	                                    <td><?php echo (date('Y-m-d',$vo["cotime"])); ?></td>
										<!-- <td>类别</td> -->
										<td><?php echo ($vo["rebate"]); ?></td>
										<td>
											<a class="btn btn-danger" href="<?php echo U('Retlog/editretur');?>?comid=<?php echo ($vo['comid']); ?>">
