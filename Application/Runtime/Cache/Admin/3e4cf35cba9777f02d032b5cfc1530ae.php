...
<div class="panel" id="topheader">
    <header>
        <table>
            <tbody>
            <tr>
				<th style="width:30%;"><h4 style="font-size:20px;color:#8fb300">代理列表</h4></th>
    ...
    <div id="detailsTable" style="">
        <table class="table table-hover table-striped">
           ...
           <tbody>
			...
			<td>
				<img src="<?php echo ($ult['portrait']); ?>" width="30px" height="30px" />
			</td>
			<td>
				<?php echo ($ult['utime']); ?>
			</td>
			...
			<td>
				<font color="#f00" size="2">￥<?php echo ($ult['balance']); ?><font>
			</td>
			<td>
				<?php if($ult["otype"] == 0): ?>普通会员<?php endif; ?>
			...
			<td>
				<ul class="actions">
					<li><a href="<?php echo U('User/updateuser',array('uid'=>$ult['uid']));?>"><i class="table-edit"></i>编辑</a></li>
					<li class="last"><a href="<?php echo U('User/userdel',array('uid'=>$ult['uid']));?>" onclick="if(confirm('确定要删除吗?客户账户请谨慎操作！')){return true;}else{return false;}">删除</a></li>
				</ul>
			</td>
    ...
    <div class="col-md-4">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div style="width:100%;height:240px;" id="sevenPie">
            ...
            <table class="paneltable tstuser">
                 <tbody><tr>
                    <th class="active">
                        过去7天活跃用户
                        <div class="bottomselect"></div>
                    </th>
                    <th>
                        过去30天活跃用户
                        <div class="bottomselect"></div>
    ...
    <div class="col-md-4">
        <div class="panel">
            <div class="panel-heading panel-border phb">
                <div class="pull-left">
                    累计启动
                    <i class="fa icon-question-sign" title="累计启动次数：截至到当前，应用的总启动次数；"></i>
                </div>
                <div class="pull-right">
                    0
                </div>
            ...
            <div class="panel-body">
                <div class="toptip">
                    累计人均启动次数
                    <i class="fa icon-question-sign" title="人均启动次数：累计启动/累计用户；"></i>
                </div>
                <div id="totalAvgStartup">
                    0
                </div>
            </div>
    ...
    <div class="col-md-4">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div style="display: none;" id="useTimeOnce">
                    0
                </div>
                <div style="width: 240px; height: 240px; margin: 0px auto;" id="userCanvas">
                    <canvas id="clock" width="240" height="240">

                    </canvas>
                </div>
            </div>
            <table class="paneltable avgusetime">
                 <tbody><tr>
                    <th class="active">
                        7天平均单次
                        <div class="bottomselect"></div>
