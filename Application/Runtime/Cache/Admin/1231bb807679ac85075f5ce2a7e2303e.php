...
BODY {background-image: URL(/Public/images/wmlogin_bg1.jpg);
...
<body>
	<section class="wmfl-admin-login">
		<div class="container">
			<div class="col-lg-6">
				<div class="wmfl-logo">
					<img src="/Public/images/wmfl_logo.png">
				</div>
					...
					<div style="background:transparent;background-color:rgba(255,255,255,0.7);filter:alpha(opacity=70);">
						<form action="" method="post" role="form" class="panel-body" id="form">
							...
							<div class="input-group">
							  ...
							  <img class="auth-img" src="<?php echo U('verify');?>" title="点击更换验证码" style="cursor:pointer;">
							</div> 
	...
	<!-- <div id="wmfl-login-lay" class="wmfl-login-lay" style="width: 1325px; height: 579px;">
		<img src="/Public/images/wmlogin_bg1.jpg" width="1325" style="display: inline;">
	</div> -->
	...
	<script type="text/javascript">
		...
		function submitForm()
		{
			...
			if ( username == "" ) {
				...
				$.post("<?php echo U('signin');?>",$("#form").serialize(),function(data){
					if(data == 0)
					{
						setTimeout(function(){
                        ...
                        setTimeout(function(){
                            location.href = "<?php echo U('/Ucenter/Index/index');?>";
                        },1000)
					}else{
						msg.html("验证码错误");
					}
					$("#submit").html("登录").removeAttr("disabled");
					$(".auth-img").attr("src", "<?php echo U('verify');?>");
