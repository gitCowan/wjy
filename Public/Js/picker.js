...
!function ($, moment) {
    //var datapicker_lang = navigator.language||navigator.userLanguage;
    //moment.lang(datapicker_lang);
    var datapicker_lang=$.cookie("i18next")||"zh-CN";
    moment.lang(datapicker_lang=="zh-CN"?"zh-cn":"en-gb");
    var DateRangePicker = function (element, options, cb) {
        ...
        var delTemplate=$('<span class="delbtn" style="display:none;"></span>');
        delTemplate.insertAfter($(element));
        delTemplate.on("click",function(){
            $(element).val("");
            $(element).trigger('delete.daterangepicker', this);
            delTemplate.hide();
        });
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.minLimit = 0;//edit by xiebin 2016-09-04
            ...
            this.locale = {
                applyLabel: i18n.t("rangepicker.ok"),
                cancelLabel: i18n.t("rangepicker.cancel"),
                fromLabel: i18n.t("rangepicker.from"),
                toLabel: i18n.t("rangepicker.to"),
                weekLabel: 'W',
        ...
        clickDate: function (e) {
            ...
            if (cal.hasClass('left')) {
                ...
                var startStr = moment(startDate).format('l');
                var endStr = moment(endDate).format('l');
                if (typeof this.minLimit === 'number' && this.minLimit > 0) {
                    if (startStr == endStr) {
                        endDate = moment(startDate).add(this.minLimit, 'days');
                    }
                }
            } else {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (this.timePicker) {
                ...
                if (this.startDate && this.timePickerIncrement) {
                    if ((this.startDate.minutes()%this.timePickerIncrement === 0)) {

                    } else {
                        this.startDate = this.startDate.minutes(0);
                    }  
                }
