define(function (require, exports, module) {
    module.exports = function (req, res) {
        ...
        var reqUrl = hostname + '/getModule?appId=' + appid + '&startNum=0&size=32&platform=-1&type=7&timepicker=' + new Date().getTime();
        var options = {
            url: reqUrl,
            json: true,
            headers: {}
        ...
        request(options, function (error, response, body) {
            ...
            if (!error && response.statusCode == 200) {
                ...
                json.title = i18n.t("cadModule.modAdded");
                json.rolePermission = req.rolePermission;
                res.render('module', json);
            } else {
